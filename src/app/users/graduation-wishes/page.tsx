...
import { 
  getOwnerGraduationWishes, 
  getOtherGraduationWishes,
  type GraduationWishesItem,
  type GraduationWishesResponse
} from '@/services/auth';
import { 
...
export default function GraduationWishesPage() {
  ...
  const [ownerData, setOwnerData] = useState<GraduationWishesItem[]>([]);
  const [otherData, setOtherData] = useState<GraduationWishesItem[]>([]);
  ...
  const handleEdit = (item: GraduationWishesItem) => {
    setEditingId(item.record_id);
    setEditContent(item.wishes);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900">My Graduation Wishes</h1>
          <p className="text-gray-600 mt-1">毕业祝福管理</p>
        </div>
          ...
          <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[80vh] overflow-hidden">
              <div className="flex items-center justify-between p-6 border-b border-gray-200">
                <h3 className="text-lg font-semibold text-gray-900">编辑毕业祝福</h3>
                <button
